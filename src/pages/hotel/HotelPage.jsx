...
export const HotelPage = () => {
  ...
  //       {open && (
  //         <div className="slider">
  //           <i className="fa-solid fa-circle-left arrow"></i>
  //           <i className="fa-solid fa-circle-right arrow"></i>
  //           <div className="sliderWrapper">
  //             <img src={photos[slideNumber].src} alt="some img" />
  //           </div>
  //           <i
  //             className="fa-solid fa-circle-xmark close"
  //             onClick={() => setOpen(false)}
  ...
  //         <div className="hotelImages">
  //           {photos.map((photo, i) => (
  //             <div key={new Date() + Math.random()} className="hotelImgWrapper">
  //               <img
  //                 onClick={() => handleImgClick(i)}
  //                 src={photo.src}
  //                 alt=""
